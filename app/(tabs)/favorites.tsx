...
export default function FavoritesScreen() {
	...
	const renderFavoriteItem = ({ item }: { item: any }) => (
		...
		>
			...
			<Ionicons name="chevron-forward" size={20} color={theme.colors.text.whiteLight} />
		</TouchableOpacity>
	);
			...
			{favorites.length > 0 ? (
				...
				<View style={{
					...
					<Text style={{
						...
						Start exploring proteins and add them to your favorites by tapping the heart icon
					</Text>
				</View>
			)}
		</View>
